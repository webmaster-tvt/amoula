...
if( class_exists('WP_Customize_Control') ) {
	...
	if( ! class_exists( 'Pofo_Alpha_Color_Control' ) ) {

		class Pofo_Alpha_Color_Control extends WP_Customize_Control {
			/**
			...
			public function enqueue() {
				wp_enqueue_script(
					'alpha-color-picker',
					POFO_THEME_ADMIN_JS_URI . '/alpha-color-picker.js',
				...
				wp_enqueue_style(
					'alpha-color-picker',
					POFO_THEME_ADMIN_CSS_URI . '/alpha-color-picker.css',
			...
			public function render_content() {
				...
				<label>
					...
					if ( isset( $this->label ) && '' !== $this->label ) {
						echo '<span class="customize-control-title screen-reader-text">' . sanitize_text_field( $this->label ) . '</span>';
					}
					if ( isset( $this->description ) && '' !== $this->description ) {
						echo '<span class="description customize-control-description">' . sanitize_text_field( $this->description ) . '</span>';
					} ?>
