<?php
    ...
    $wp_customize->add_setting( 'pofo_default_subtitle_opacity', array(
        'default'           => '',
        'sanitize_callback' => 'esc_attr'
    ) );

    $wp_customize->add_control( 'pofo_default_subtitle_opacity', array(
        'label'             => esc_attr__( 'Subtitle Opacity', 'pofo' ),
        'section'           => 'pofo_add_default_title_section',
        'settings'          => 'pofo_default_subtitle_opacity',
        'type'              => 'select',
		'choices'           => array(
									''		=> esc_html__( 'Default', 'pofo' ),
								    '0.0'   => esc_html__( 'No Opacity', 'pofo' ),
