        ...
        echo '<div class="'.esc_attr( $pofo_single_post_content_container_fluid ).esc_attr( $pofo_single_post_layout_setting ).'">';
            echo '<div class="row">';
                ...
                get_template_part( 'templates/single-post', 'left' );
                    ...
                    if( $pofo_hide_comment == 1 && $pofo_hide_related_posts == 1 ) {
                        if ( comments_open() || get_comments_number() ) {
                            echo '<div class="col-md-12 col-sm-12 col-xs-12 margin-two-top sm-no-margin-top">';
                                echo '<div class="divider-full bg-medium-light-gray"></div>';
                            echo '</div>';
                        }
                    }
