<?php
    ...
    echo '<ul class="portfolio-grid hover-option1 '.$portfolio_columns.$class_list.'">';
                                ...
                                echo '<div class="'.$vertical_alignment_class.'portfolio-hover-box">';
                                    echo '<div class="portfolio-hover-content position-relative">';
                                        if($pofo_show_separator == 1):
                                            echo '<div class="pofo-portfolio-archive-page-separator bg-black margin-six-bottom separator-line-horrizontal-medium-light2 display-inline-block"></div>';
                                        endif;
