<?php
    ...
    echo '<ul class="portfolio-grid hover-option6 '.$portfolio_columns.$class_list.'">';
        ...
        while ( have_posts() ) : the_post();
            ...
            echo '<li '.$pofo_portfolio_archive_classes.$pofo_animation_delay_attr.'>';
                ...
                echo '<figure>';
                    ...
                    echo '<div class="pofo-portfolio-archive-page-background portfolio-img bg-deep-pink position-relative text-center overflow-hidden">';
                        ...
                        echo '<div class="portfolio-icon">';
                            if( $pofo_show_internal_link == 1 ):
                                echo '<a class="text-center" href="'.esc_url( $pofo_portfolio_external_link ).'"'.$pofo_portfolio_link_target.'><i class="fas fa-link text-extra-dark-gray" aria-hidden="true"></i></a>';
                            endif;
                            if( $pofo_portfolio_archive_page_show_lightbox == 1 ):
                                echo '<a class="gallery-link" '.$image_lightbox_title.$image_lightbox_caption.' href="'.esc_url( $image_url ).'" data-group="general-portfolio"><i class="fas fa-search text-extra-dark-gray" aria-hidden="true"></i></a>';
                            endif;
                        echo '</div>';
                    echo '</div>';
