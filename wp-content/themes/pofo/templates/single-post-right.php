...
<?php
	...
	$pofo_single_post_right_sidebar = pofo_option( 'pofo_single_post_right_sidebar', 'sidebar-1' );
	$pofo_single_post_left_sidebar = pofo_option( 'pofo_single_post_left_sidebar', '' );
