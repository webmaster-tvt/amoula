...
/*-----------------------------------------------------------------------------------*/
  ...
  $team_member_slider_class = 'pofo_team_member_slider_'.time() . '-2-' . rand( 0, 100 );
  vc_map( 
    array(
        'name' => esc_html__( 'Team Member Slider' , 'pofo-addons' ), //Name of your shortcode for human reading inside element list
        'base' => 'pofo_team_member_slider', //Shortcode tag. For [my_shortcode] shortcode base is my_shortcode
        'description' => esc_html__( 'Create a team member slider', 'pofo-addons' ), //Short description of your element, it will be visible in 'Add element' window
        'icon' => 'fas fa-users pofo-shortcode-icon', //URL or CSS class with icon image.
        'category' => 'Pofo',
        'params' => array( //List of shortcode attributes. Array which holds your shortcode params, these params will be editable in shortcode settings page
            array(
              ...
              'param_name' => 'pofo_team_member_slider_style',
              'value' => array( esc_html__( 'Select style', 'pofo-addons') => '',
                                esc_html__( 'Team carousel style 1', 'pofo-addons') => 'team-style-1',
                                esc_html__( 'Team carousel style 2', 'pofo-addons') => 'team-style-2',
                              ),
            ),
            array(
              'type' => 'pofo_preview_image',
              'heading' => esc_html__( 'Select pre-made style for block', 'pofo-addons'),
              'param_name' => 'pofo_team_member_slider_preview_image',
              'admin_label' => true,
              'value' => array( esc_html__( 'Team carousel image', 'pofo-addons') => '',
                                esc_html__( 'Team carousel style 1', 'pofo-addons') => 'team-style-1',
                                esc_html__( 'Team carousel style 2', 'pofo-addons') => 'team-style-2',
                              ),
            ),
            array(
              ...
              'dependency' => array( 'element' => 'pofo_team_member_slider_style', 'value' => array('team-style-1', 'team-style-2') ),
            ),
            array(
              'type' => 'dropdown',
            ...
            array(
              ...
              'dependency' => array( 'element' => 'pofo_team_member_slider_style', 'value' => array('team-style-1') ),
            ),
            array(
            ...
            array(
              'param_name' => 'pofo_team_member_slides', // all params must have a unique name
              ...
              'params' => array(
                  ...
                  array(
                    'type' => 'dropdown',
                    'heading' => esc_html__( 'Name link target', 'pofo-addons'),
                  ...
                  array(
                    'type' => 'textfield',
                    'heading' =>esc_html__( 'Name link / URL', 'pofo-addons'),
            ...
            array(
              ...
              'dependency' => array( 'element' => 'pofo_team_member_slider_style', 'value' => array('team-style-2') ),
            ...
            array(
              'type' => 'colorpicker',
              'class' => '',
              'heading' => esc_html__( 'Name link hover color', 'pofo-addons' ),
            ...
            array(
              'param_name' => 'pofo_custom_member_name_heading', // all params must have a unique name
              'type' => 'pofo_custom_title', // this param type
              'value' => esc_html__( 'Member Name Typography', 'pofo-addons' ), // your custom markup
            ...
            array(
              'param_name' => 'pofo_custom_member_designation_heading', // all params must have a unique name
              'type' => 'pofo_custom_title', // this param type
              'value' => esc_html__( 'Member Designation Typography', 'pofo-addons' ), // your custom markup
              'group' => esc_html__( 'Typography', 'pofo-addons' ),
              'responsive_settings' => true,
