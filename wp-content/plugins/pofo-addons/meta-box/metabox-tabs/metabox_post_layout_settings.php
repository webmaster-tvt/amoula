...
pofo_meta_box_text( 'pofo_main_top_section_space_single',
...
pofo_meta_box_text( 'pofo_main_bottom_section_space_single',
...
pofo_meta_box_upload( 'pofo_post_body_background_image_single', 
			esc_html__( 'Body Background Image', 'pofo-addons' ),
			''
		);
pofo_meta_box_dropdown(	'pofo_post_background_size_single',
...
pofo_meta_box_dropdown(	'pofo_post_background_postion_single',
...
pofo_meta_box_dropdown(	'pofo_post_background_attachment_single',
...
pofo_meta_box_dropdown(	'pofo_post_background_repeat_single',
