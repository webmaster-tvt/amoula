...
pofo_meta_box_dropdown('pofo_page_layout_setting_single',
...
pofo_meta_box_dropdown_sidebar(	'pofo_page_left_sidebar_single',
				esc_html__('Left Sidebar', 'pofo-addons'),
				$pofo_sidebar_array,
				esc_html__('Select sidebar to display in left column of page', 'pofo-addons'),
				array( 'element' => 'pofo_page_layout_setting_single', 'value' => array('default','pofo_layout_left_sidebar','pofo_layout_both_sidebar' ))
			);
pofo_meta_box_dropdown_sidebar(	'pofo_page_right_sidebar_single',
				esc_html__('Right Sidebar', 'pofo-addons'),
				$pofo_sidebar_array,
				esc_html__('Select sidebar to display in right column of page', 'pofo-addons'),
				array( 'element' => 'pofo_page_layout_setting_single', 'value' => array('default','pofo_layout_right_sidebar','pofo_layout_both_sidebar' ))
			);
pofo_meta_box_dropdown(	'pofo_page_container_style_single',
...
pofo_meta_box_text( 'pofo_page_top_section_space_single',
...
pofo_meta_box_text( 'pofo_page_bottom_section_space_single',
...
pofo_meta_box_upload( 'pofo_page_body_background_image_single', 
			esc_html__( 'Body Background Image', 'pofo-addons' ),
			''
		);
pofo_meta_box_dropdown(	'pofo_page_background_size_single',
...
pofo_meta_box_dropdown(	'pofo_page_background_postion_single',
...
pofo_meta_box_dropdown(	'pofo_page_background_attachment_single',
...
pofo_meta_box_dropdown(	'pofo_page_background_repeat_single',
